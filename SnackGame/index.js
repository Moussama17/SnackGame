...
const startAgainBtn = document.querySelector("#startAgainBtn"); // Ensure this ID matches the one in your HTML
const gameWidth = 500;
const gameHeight = 500;
gameBord.width = gameWidth;
gameBord.height = gameHeight;
